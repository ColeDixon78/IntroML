...
Sales = 13.043469 + (-0.054459 \* Price) + (-0.021916 \* Urban) + (1.200573 \* US) where a Yes value corresponds to 1 and a No value corresponds to 0 for the dummy variables Urban and US
